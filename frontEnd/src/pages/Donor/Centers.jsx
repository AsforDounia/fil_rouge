...
import { FaMapMarkerAlt, FaFilter, FaInfoCircle, FaHeart, FaStethoscope, FaUsers, FaSearch, FaSpinner, FaClock, FaPhoneAlt, FaChevronLeft, FaChevronRight, FaTimes } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-lightGray">
          ...
          <div className="mb-8 flex items-center gap-4">
            ...
            <button className="bg-darkteal hover:bg-teal text-white rounded-lg py-3 px-6 font-medium flex items-center gap-2 transition-all duration-300 cursor-pointer">
              <FaFilter />
              <span>Filtres</span>
            </button>
          </div>

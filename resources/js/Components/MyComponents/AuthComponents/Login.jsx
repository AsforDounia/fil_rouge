      ...
      <div className="w-full max-w-4xl">
        <div className="bg-white shadow-lg rounded-xl overflow-hidden flex">
          ...
          <div
            ...
            style={{
              backgroundImage: 'url(https://source.unsplash.com/random/900×700/?blood,donation)',
          ...
          <div className="w-1/2 p-12">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-burgundy mb-2">Connexion</h2>
              <p className="text-darkTeal">Accédez à votre compte BloodLink</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <a href="/forgot-password" className="text-wine hover:underline">
                  Mot de passe oublié ?
                </a>
              </div>
            ...
            <div className="text-center">
              <p>
                ...
                <a href="register" className="text-wine hover:underline">
                  Inscrivez-vous
                </a>
              </p>
            </div>
